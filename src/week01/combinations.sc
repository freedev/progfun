...
object combinations {
     ...
     def combinations(coins: List[Int]): List[List[Int]] = {
         def loop(start: Int, pos: Int, size: Int, combs: List[List[Int]]): List[List[Int]] = {
           ...
           if ((pos + size) < coins.size)
           	 loop(start, pos, size + 1, combs)
           else if (pos < coins.size) {
          	 loop(start, pos + 1, 1, combs)
         	 } else if (start < coins.size) {
         	   loop(start + 1, start + 1, 1, combs :+ coins.slice(start, pos))
         	 } else
         	   combs
         }
         loop(0, 0, 1, List())
  ...
  combinations(list)                              //> start: 0 pos: 0 size: 1
                                                  ...
                                                  //| start: 1 pos: 4 size: 1
                                                  //| start: 2 pos: 2 size: 1
                                                  //| start: 2 pos: 2 size: 2
                                                  //| start: 2 pos: 3 size: 1
                                                  //| start: 2 pos: 4 size: 1
                                                  //| start: 3 pos: 3 size: 1
                                                  //| start: 3 pos: 4 size: 1
                                                  //| start: 4 pos: 4 size: 1
                                                  //| res0: List[List[Int]] = List(List(1, 2, 3, 4), List(2, 3, 4), List(3, 4), Li
                                                  //| st(4))
